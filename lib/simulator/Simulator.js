...
import ConditionalStartEventBehavior from "./behaviors/ConditionalStartEventBehavior";
...
export default function Simulator(injector, eventBus, elementRegistry) {
  ...
  this.registerBehavior('bpmn:StartEventCondition', new ConditionalStartEventBehavior(this, this, elementRegistry));
}
