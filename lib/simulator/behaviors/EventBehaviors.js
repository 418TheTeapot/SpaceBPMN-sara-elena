...
EventBehaviors.prototype.handleConditionalEvent = function(context) {
  ...
  const condizione = element.businessObject.eventDefinitions[0].condition.body;

  if (condizione === 'destinationUnreachable') {
    console.log('ConditionalEventDefinition triggered:', condizione);
    alert("Conditional event 'destinationUnreachable' triggered");
    ...
    console.log('ConditionalEventDefinition non attivata.');
...
EventBehaviors.prototype.handleStartEventConditional = function(context) {
  ...
  // La condizione viene passata come parametro del contesto
  const condition = element.businessObject.eventDefinitions[0].condition.body;

  // La condizione di aggiornamento viene gestita nella funzione _checkConditionalStartEvents
  if (condition) {
