...
//prende come punto di inizio l'element che nell'array di place si trova subito prima di destination
    function getStart() {
        for (let i = 0; i < place.length; i++) {
  ...
  var shortestpath = g.Dijkstra(getStart(), getDestination()); //prende il metodo getStart anzichè getRoot
