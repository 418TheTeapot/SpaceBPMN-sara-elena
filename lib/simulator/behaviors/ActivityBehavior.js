...
import {removeShape} from "bpmn-js/lib/features/modeling";
...
ActivityBehavior.prototype.addConnectionBetweenPlaces = function(sourcePlaceName, targetPlaceName) {
  //boh
}
...
ActivityBehavior.prototype.processAssignments = function(context) {
  ...
  if (assignmentObj["delete"]) {
    ...
    if (connectionToDelete) {
      ...
      console.log(Object.getOwnPropertyNames(Object.getPrototypeOf(canvas._elementRegistry)));



      console.log("Canvas eleregistry remove da dove lo prende?:", canvas._elementRegistry)
  ...
  if (assignmentObj["add"]) {
    ...
    this.addConnectionBetweenPlaces(sourcePlaceName, targetPlaceName);
  }
