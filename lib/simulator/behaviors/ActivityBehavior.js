...
// Definisci un oggetto globale per memorizzare le prime root
const initialRoots = {};
    ...
    if (element.parent.businessObject.root) {
      ...
      if (element.businessObject.destination === element.parent.businessObject.root) {
        ...
        if (initialRootId) {
          ...
          console.log(`Root reimpostata alla prima root salvata: ${getNameRoot(initialRootId, this._spaceModeler._places.get('Elements'))}`);
